...
class PHPMailer
{
     ...
     * @return mixed|string
     */
    public function getHost($smtp_name)
    {
        $_emailSMTP = [
            'aliyun' => "smtp.aliyun.com", #阿里云邮箱（mail.aliyun.com）
            'sina' => "smtp.sina.com.cn", #新浪邮箱（sina.com）
            'google' => "smtp.gmail.com", #谷歌邮箱(google.com)
            'top' => "smtp.tom.com", #Tom邮箱（top.com）
            '163' => "smtp.163.com", #网易邮箱（163.com）
            '126' => "smtp.126.com", #126邮箱
            'yahoo' => "smtp.mail.yahoo.com", #雅虎邮箱（yahoo.com）
            'qq' => "smtp.qq.com", #QQ邮箱（mail.qq.com）
            'sohu' => "smtp.sohu.com", #搜狐邮箱（sohu.com）
            'china' => "smtp.china.com", #中华网邮箱（china.com）
        ];

        if (isset($_emailSMTP[$smtp_name])){
            return $_emailSMTP[$smtp_name];
        }else{
